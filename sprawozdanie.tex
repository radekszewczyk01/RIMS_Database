...
Pliki \texttt{polecenie.md} oraz \texttt{pomoc.md} powstały przy użyciu narzędzia \textbf{Gemini}. Do Gemini załączono plik \texttt{MojeERD.csv}, który został wyeksportowany z narzędzia \textbf{Lucidchart} na podstawie stworzonego tam schematu bazy danych.
...
\section{Model danych i normalizacja (3NF)}
...
\section{Dane testowe i przykładowe wyniki}
...
\section{Skrypty bash i uruchomienie}
...
\section{Uwierzytelnianie i środowisko}
...
\section{Gdzie są przechowywane dane}
